...
while True:
    ...
    if hands:
        for hand in hands:
            ...
            if index_x and thumb_x and abs(index_y - thumb_y) < 20:
                pyautogui.click()
                time.sleep(0.1)  # Shorter sleep to increase responsiveness
            elif index_x and thumb_x and abs(index_y - thumb_y) < 100:
